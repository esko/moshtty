...
| M7 Real remote acceptance     | In progress        | Reload reattach now preserves the Mac pane and renders shell output after reconnect; remaining M7 acceptance covers split/app-layout and lost-pane cases |
