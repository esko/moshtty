...
| M7 Real remote acceptance     | In progress        | Reload reattach slice persists remote flow IDs and reuses the same Mac pane; visible terminal output after reattach remains a blocker                    |
